...
namespace PDM_help_addin
{
    /// <summary>
    /// Summary description for PDM_help_addin.
    /// </summary>
    [Guid("10b85c0a-5c34-4b88-b575-de10e3ed9506"), ComVisible(true)]
    [SwAddin(
        Description = "PDM_help_addin description",
        Title = "PDM_help_addin",
        LoadAtStartup = true
        )]
    public class SwAddin : ISwAddin
    {
        ...
        public void AddCommandMgr()
        {
            ...
            cmdGroup.LargeIconList = iBmp.CreateFileFromResourceBitmap("PDM_help_addin.ToolbarLarge.bmp", thisAssembly);
            cmdGroup.SmallIconList = iBmp.CreateFileFromResourceBitmap("PDM_help_addin.ToolbarSmall.bmp", thisAssembly);
            cmdGroup.LargeMainIcon = iBmp.CreateFileFromResourceBitmap("PDM_help_addin.MainIconLarge.bmp", thisAssembly);
            cmdGroup.SmallMainIcon = iBmp.CreateFileFromResourceBitmap("PDM_help_addin.MainIconSmall.bmp", thisAssembly);
